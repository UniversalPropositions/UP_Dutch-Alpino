...
- `git clone https://github.com/UniversalPropositions/UP_Dutch-Alpino.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Dutch-Alpino>/ --input_up=<up_path_to_UP_Dutch-Alpino>/ --output=<path_to_UD+UP_Dutch-Alpino>/`
